...
st.write("DEBUG SECRET CHECK — DO NOT DEPLOY WITH THIS!")
st.write("KAGGLE_USERNAME exists:", "KAGGLE_USERNAME" in st.secrets)
st.write("KAGGLE_KEY exists:", "KAGGLE_KEY" in st.secrets)
